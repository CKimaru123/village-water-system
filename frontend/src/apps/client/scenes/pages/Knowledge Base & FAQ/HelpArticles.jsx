  ...
  return (
    <Box m="20px">
      ...
      <Tabs value={tab} onChange={(_, v) => setTab(v)} sx={{ mb: 2,
        ...
        <Tab icon={<ArticleIcon sx={{ fontSize: 18 }} />} iconPosition="start"
          label={`All (${allArticles.length})`} />
        <Tab icon={<RssFeedIcon sx={{ fontSize: 18 }} />} iconPosition="start"
          label={`Blog Posts (${blogPosts.length})`} />
        <Tab icon={<MenuBookIcon sx={{ fontSize: 18 }} />} iconPosition="start"
